...
public class ProjectBO {
	...
	public File getProjectImages(long imageId) {
	 ...
	 StringBuilder url=new StringBuilder(rootDirectory).append(File.separator).append(image.getProject().getId()).append(File.separator).append(image.getProperty().getId()).append(File.separator).append(image.getImageName());
